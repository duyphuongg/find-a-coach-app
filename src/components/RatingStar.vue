<template>
  <div class="star-rating" :aria-label="rating + ' of 5'">
    <div v-for="(star, index) in stars" :key="index" class="star-container">
      ...
      >
        <polygon
          points="6.320 0.922, 4.797 4.039, 1.352 4.531, 0.953 5.820, 3.414 8.234, 2.828 11.633, 3.930 12.430, 7.000 10.813, 10.047 12.430, 11.148 11.633, 10.563 8.234, 13.023 5.820, 12.625 4.531, 9.203 4.039, 7.656 0.922, 6.320 0.922"
...
export default {
  ...
  data: function () {
    return {
      ...
      styleStarWidth: 14,
      styleStarHeight: 14,
      styleEmptyStarColor: '#E4E4E4',
      styleFullStarColor: '#FAAD14',
    };
  },
  directives: {},
  computed: {
